...
def f_ode(y, alpha):
    """
    Defines the right hand side of the ODE system to be solved by solve_euler.
    """
    x1, x2 = y
...
def cusp_bifurcation(alpha_1, alpha_2, x):
    """ 
    """
    return alpha_1 + alpha_2 * x - x**3

def cusp_bifurcation1(alpha_2, x):
    """ 
    """
    return - alpha_2 * x + x**3